...
IF NOT EXISTS (SELECT * FROM sys.database_principals WHERE name = N'wms')
BEGIN
    CREATE USER [wms] WITHOUT LOGIN WITH DEFAULT_SCHEMA=[dbo]
    EXEC sp_addrolemember N'db_securityadmin', N'wms'
END;
GO

--CREATE LOGIN [wms] WITH PASSWORD = N'111',
--                DEFAULT_DATABASE = [OSM],
--                CHECK_EXPIRATION=OFF,
--                CHECK_POLICY=OFF
-- GO
--EXEC master..sp_addsrvrolemember @loginame = N'wms', @rolename = N'sysadmin'
--GO